...
class Sponsors extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ScreenHelper(
        desktop: SponsorUI(width: kDesktopMaxWidth),
        tablet: SponsorUI(width: kTabletMaxWidth),
        mobile: SponsorUI(width: getMobileMaxWidth(context)),
      ),
    );
  }
}

class SponsorUI extends StatelessWidget {
  const SponsorUI({Key key, @required this.width}) : super(key: key);
  final double width;
  @override
  Widget build(BuildContext context) {
    return Center(
